...
export class DaysService {
  ...
  private thirtyDayMonthResults: number[] = [...Array(30).keys()].map(i => i + 1);
  public readonly thirtyOneDayMonths = [1, 3, 5, 7, 8, 10, 12];
  private thirtyOneDayMonthResults: number[] = [...Array(31).keys()].map(i => i + 1);
  public readonly twentyNineDayMonth = 2;
  private twentyNineDayMonthResults: number [] = [...Array(29).keys()].map(i => i + 1);
